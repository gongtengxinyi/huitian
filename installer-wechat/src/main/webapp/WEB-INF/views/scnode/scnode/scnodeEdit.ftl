...
<script src="static/scripts/scnode/scnode/scnodeEdit.js?randomId=<%=Math.random()%>"></script>
  ...
  <div ng-controller="ScnodeController">
      ...
      <div class="col-md-12">
        <ol class="breadcrumb">
          ...
          <li class="active"><span
            class="glyphicon glyphicon-triangle-bottom"></span>&nbsp;编辑服务节点</li>
        </ol>
      </div>
    </div>
    ...
    <form name="form1" class="form-horizontal" novalidate>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">服务节点修改</div>
          ...
          <div class="form-group"
            ...
            <div class="col-md-4">
              <input type="text" positive-integer class="form-control"
                name="orders" ng-model="data.orders" required>
            </div>
          </div>
          <div class="row">
