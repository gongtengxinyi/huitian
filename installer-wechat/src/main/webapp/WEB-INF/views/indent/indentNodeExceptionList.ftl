...
<script src="static/scripts/indent/indentNodeExceptionList.js?randomId=<%=Math.random()%>"></script>
</head>
<body ng-init="data.indentNodeId='${indentNodeId}'; data.indentId='${indentId}'">
  <#include "/include/body-begin.ftl" />
  <div ng-controller="IndentNodeExceptionController">
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody ng-repeat="data in rows">
            <tr>
              ...
              <td><a href="indentExc/manageException.do?id={{data.id}}&&pageNo={{pageNo}}" class="btn btn-success btn-xs">详细信息</a></td>
            </tr>
          </tbody>
        </table>
        <div class="row">
