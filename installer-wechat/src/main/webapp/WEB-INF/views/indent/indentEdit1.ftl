...
<script type="text/javascript"
	src="static/scripts/indent/indentEdit1.js?randomId=<%=Math.random()%>"></script>
</head>
<body
							...
							<div class="form-group"
								...
								<div class="col-md-8">
									<input type="text" class="form-control"
										...
										uib-tooltip="此项为必填项"
										tooltip-enable="form1.designerMobile.$invalid" >
									<div
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group"
								...
								<div class="col-md-8">
									<input type="text" class="form-control" name="workerRate"
										ng-model="data.workerRate" numeric decimals="2"
										ng-pattern="/^-?(100|(([1-9]\d|\d)(\.\d{1,2})?))$/">
									<div
						...
						<div class="col-md-6">
							<div class="form-group"
								...
								<div class="col-md-8">
									<input type="text" class="form-control" name="managerRate"
										ng-model="data.managerRate" numeric decimals="2"
										ng-pattern="/^-?(100|(([1-9]\d|\d)(\.\d{1,2})?))$/">
									<div
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-md-9" id="divServeType">
							<table class="table table-bordered">
								<tr>  <!-- 判断该品类是不是存在于品类字符串中，如果存在，说明该品类中有订单内容，就选中该checkbox -->
									<td><#list type.sortList as sort>
									  <#if sortIdStr.contains(sort.id)> 
									   <input type="checkbox"
										value="${sort.id}" id="sort_${sort.id}"
										ng-click="add('${sort.id}')" ng-model="sort_${sort.id}" ng-init="sort_${sort.id}=true" >
										${sort.name1}&nbsp;&nbsp;&nbsp;&nbsp; </#if>
										<!-- 判断该品类是不是存在于品类字符串中，如果bu存在，说明该品类中没有订单内容，就取消选中该checkbox -->
										<#if !sortIdStr.contains(sort.id)> 
                     <input type="checkbox"
                    value="${sort.id}" id="sort_${sort.id}"
                    ng-click="add('${sort.id}')" ng-model="sort_${sort.id}" ng-init="sort_${sort.id}=false" >
                    ${sort.name1}&nbsp;&nbsp;&nbsp;&nbsp; </#if>
					...
					<div class="form-group">
						...
						<div class="col-md-9" id="content"> 
							<#list type.sortList as sort>    <!-- 判断该品类是不是存在于品类字符串中，如果不存在，说明该品类中没有订单内容，就隐藏该div -->
							<div class="form-group" id="offer_${sort.id}"  <#if !sortIdStr.contains(sort.id)>  style="display:none" </#if>>
								...
								<table class="table table-border">
									<tr>
										...
										<td><!-- <input type="checkbox" id="price_${content.id}" 
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" name="contacts"
										ng-model="data.indentFreight.contacts">
								</div>
							</div>
						</div>
						<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<textarea type="text" class="form-control" name="detailAddr1"
								ng-model="data.contact.detailAddr1" required>
              </textarea>
						</div>
						<div class="col-md-3"
							...
							<textarea type="text" class="form-control" name="buildingNum"
								...
								tooltip-enable="form1.buildingNum.$invalid"
            ...
            <div class="col-md-2" ng-show="data.indentAssignSelected">
              <select class="form-control" name="workerId"
                ...
                ng-options="worker.v as worker.n for worker in workers">
						...
						<div class="col-md-2"
							ng-show="data.indentAssignSelected && (data.assignType=='WORKER' || data.assignType=='MANAGER')">
