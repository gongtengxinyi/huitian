...
[ '$scope', '$http', '$window','$uibModal', 'UrlUtil',
  ...
  $scope.update = function() {
	    ...
	    /*$http.post('indentTiaozheng/doSaveMoneyWorker.do', $scope.data).then(function(response) {
	    ...
	    return $http({
	        method : 'POST',
	        url : 'indentTiaozheng/doSaveMoneyWorker.do', 
	        headers : {
...
//保存后刷新页面
  $scope.refresh=function(){		 
		  $window.location.href = UrlUtil.transform('indentTiaozheng/indentMoneyAddWorker.do?indentId='+$scope.data.indentId+'&pageNo='+pageNo);
  }
