...
<script type="text/javascript"
  src="static/scripts/account/managerMsg.js?randomId=<%=Math.random()%>"></script>
</head>
<body ng-init="data.id='${id}'">
  <#include "/include/body-begin.ftl" />
  <div ng-controller="managerMsgController">
 ...
 -->
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <textarea type="text" class="form-control" ng-model="data.remarks"
                disabled></textarea>
            </div>
          </div>
          <div class="form-group">
