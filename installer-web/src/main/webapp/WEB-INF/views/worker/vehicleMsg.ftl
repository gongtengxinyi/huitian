...
<script type="text/javascript"
  src="static/scripts/account/vehicleMsg.js?randomId=<%=Math.random()%>"></script>
</head>
<body ng-init="data.id='${id}'">
  <#include "/include/body-begin.ftl" />
  <div ng-controller="vehicleMsgController">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-6">
             ...
             <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <p class="form-control-static">{{data.account.crtDate}}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <p class="form-control-static">{{data.vehicleStatusDisp}}</p>
            </div>
          </div>
          <div class="form-group">
