...
<script type="text/javascript"
  src="static/scripts/account/managerEdit.js?randomId=<%=Math.random()%>"></script>
</head>
                  ...
                  <div class="col-md-10">
                    <figure itemprop="associatedMedia" itemscope>
                      <a href="{{data.charter}}" itemprop="contentUrl"
                        data-size="{{data.charterImgWidth}}x{{data.charterImgHeight}}"><img
                        ng-src="{{data.charter}}" itemprop="thumbnail"
                        alt="营业执照" width="{{data.charterImgWidthThumbnail}}" height="{{data.charterImgHeightThumbnail}}"  /> </a>
                    </figure>
                  </div>
                </div>
              </div>
