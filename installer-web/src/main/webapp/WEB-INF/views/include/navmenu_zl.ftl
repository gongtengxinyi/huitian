	...
	<table width="100%" border="0">
		...
		<tr>
			<td width="80%" colspan="2" align="right">
				...
				href="indent/indentList.do?isAPI=overTimeScrab" title="计划上门日期当天尚未抢单">超时未抢单<span
				...
				Session.USER_BEAN.indentRole?contains('indentQA')> <a
				class="btn btn-warning" href="indent/indentList.do?isAPI=CONTINUE">继续上门订单<span
					class="badge" ng-bind="continueIndentCount"></span></a><a
				class="btn btn-danger" href="indent/indentList.do?status=EXCEPTION" title="工人提报了反馈信息">异常订单<span
						...
						<div class="mj_menu_pro_main">
							<div class="mj_menu_pro_li">
								<div class="mj_menu_li_txt">
									...
									</#if> <br /> <a href="reportIndent/dayIndent.do">订单日报</a>
									<#if Session.USER_BEAN.apartyId==''>
									<p>
										<font>周报</font><br /> <a
							...
							<div class="mj_menu_pro_li">
								<div class="mj_menu_li_txt">
									<font>月报</font><br /> <a
										href="workerDailylog/workerMonthlyReportListlog.do">工匠注册月报<br />
										<a href="managerDailylog/managerMonthlyReportListlog.do">
											经理人注册月报<br /> 订单月报<br /> 甲方月度对账单<br />
											经理人月度对账单&nbsp;&nbsp;<br /> 工匠月度对账单 
								</div>
							</div>
							<div class="mj_menu_pro_li">
								<div class="mj_menu_li_txt">
									<p>
										<font>季报</font><br /> <a
											href="workerDailylog/workerQuarterlyReportListlog.do">工匠注册季报<br />
											<a href="managerDailylog/managerQuarterlyReportListlog.do">经理人注册季报<br />
												订单季报<br /> 甲方季度对账单<br /> 经理人季度对账单&nbsp;&nbsp;&nbsp;&nbsp;<br />
												工匠季度对账单<br /> <a href="indent/goCountInformation.do">
													首装成功率</a>
								</div>
							</div>
							</#if>
				...
				<div class="submenu">
					<div class="mj_menu_pro_bg">
						<div class="mj_menu_pro_main">
							...
							<div class="mj_menu_pro_li">
								<div class="mj_menu_li_txt">
									<font>系统参数设置</font>&nbsp;&nbsp;&nbsp;&nbsp;<br /> <a
										...
										href="sctype/goSctypeNodeTree.do">订单节点管理</a> <br /> <a
										href="sctype/sctypeList.do">签约品类</a><br /> <a
										href="sctype/sctypeTree.do">服务类别</a> <#if
									Session.USER_BEAN.isAdmin=='true'><br /> <a
							...
							</#if> <#if Session.USER_BEAN.apartyId!=''>
							<div class="mj_menu_pro_li">
								<div class="mj_menu_li_txt">
									<font>系统参数设置</font>&nbsp;&nbsp;&nbsp;&nbsp;<br /> <a
