...
<script type="text/javascript" src="static/scripts/indent/extraIndentEdit3.js?randomId=<%=Math.random()%>"></script>
</head>
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-md-6">
             ...
             <div class="col-md-6" ng-if="data.itemId!=''">
              <div class="form-group">
                <label class="control-label required col-md-4">项目名称：</label>
                <div class="col-md-8">
                  <input type="text" class="form-control"
                    value="${itemName1}" disabled> <input
                    type="hidden" name="itemId" ng-model="data.priceNameIdJiafang">
                </div>
              </div>
            </div>
          </div>
              ...
              <table class="table table-border">
                ...
                <tr>
                  ...
                  <td><!-- <input type="checkbox"
                    ng-model="data.indentPriceDto.indentPrice_${content.id}_checked" disabled> -->${content.desc1}
                    <#if Session.USER_BEAN.adminRole=='normal'> <!-- 管家用户才能看此输入框 -->
                    <input  class="form-control" type="text" name="countsJiafang"
                    ng-model="data.indentPriceDto.indentPrice_${content.id}_countsJiafang"
                    style="width: 50px; display: inline-block; margin: 0 15px;" disabled></#if><input
