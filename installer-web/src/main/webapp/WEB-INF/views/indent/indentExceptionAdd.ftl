...
<script type="text/javascript" src="static/scripts/indent/indentExceptionAdd.js?randomId=<%=Math.random()%>"></script>
</head>
    ...
    <input type="hidden" id="indentId" ng-model="data.indentId" value="${id}" ng-init="data.indentId='${id}'">
      <div class="panel panel-default">
        ...
        <div class="form-group"
         ...
         <div class="form-group" >
            <label class="control-label required col-md-2">上传图片：</label>
            <div class="col-md-10">
              <div class="row">
                <div class="col-md-12">
                    <input type="file" name="imgFiles" file-model="file.imgFiles" accept="image/jpeg,image/png,image/gif,image/jpg" multiple />
                </div>
              </div>
