<#include "/include/common.ftl" /> <#include
"/include/common-entry.ftl"/>
...
<script src="static/scripts/sctype/sctype/sctypeTree.js?randomId=<%=Math.random()%>"></script>
      ...
      <div class="col-md-12">
        <ol class="breadcrumb">
          ...
          <li class="active"><span
            class="glyphicon glyphicon-triangle-bottom"></span>&nbsp;服务类型展示树</li>
        </ol>
      </div>
    </div>
