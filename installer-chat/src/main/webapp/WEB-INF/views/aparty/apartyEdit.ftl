...
<script src="static/scripts/aparty/apartyEdit.js?randomId=<%=Math.random()%>"></script>
...
<body ng-init="data.id='${id}'">
  ...
  <div ng-controller="ApartyController">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="code1"
                  class="control-label required col-md-4">甲方代码：</label>
                <div class="col-md-8">
                  <input type="text" class="form-control" id="code1"
                    name="code1" ng-model="data.code1" disabled>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group"
                ng-class="{ 'has-error': form1.name1.$invalid}">
                <label for="name1"
                ...
                <div class="col-md-8">
                  <input type="text" class="form-control" id="name1"
                    ...
                    uib-tooltip="此项为必填项"
                    tooltip-enable="form1.name1.$invalid" disabled>
                </div>
              </div>
            </div>
          </div>
          <div class="form-group"
            ...
            <label class="control-label required col-md-2">甲方行业：</label>
            <div class="col-md-4">
