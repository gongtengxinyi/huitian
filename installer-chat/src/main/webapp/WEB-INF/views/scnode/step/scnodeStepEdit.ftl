...
<script src="static/scripts/scnode/step/scnodeStepEdit.js?randomId=<%=Math.random()%>"></script>
  ...
  <div ng-controller="ScnodeStepController">
      ...
      <div class="col-md-12">
        <ol class="breadcrumb">
          ...
          <li class="active"><span
            class="glyphicon glyphicon-triangle-bottom"></span>&nbsp;编辑服务步驟</li>
        </ol>
      </div>
    </div>
    ...
    <form name="form1" class="form-horizontal" novalidate>
      <div class="panel panel-default">
        <div class="panel-heading">服务节点步骤修改</div>
        <div class="panel-body">
          <div class="form-group">
            <label class="control-label col-md-2">服务节点代码：</label>
            <div class="col-md-10">
              <input type="text" class="form-control"
                ng-model="data.scnode.code1" disabled>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-10">
              <input type="text" class="form-control"
                ng-model="data.scnode.name1" disabled>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label class="control-label col-md-4">节点步骤类型：</label>
                <div class="col-md-8">
                  <select type="text" class="form-control"
                    name="stepType" ng-model="data.stepType" disabled>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <select type="text" class="form-control" name="sortId"
                    ng-model="data.sortId" disabled> <#list
                    sortList as s>
                    <option value="${s.value}">${s.text}</option>
                    </#list>
                  </select>
