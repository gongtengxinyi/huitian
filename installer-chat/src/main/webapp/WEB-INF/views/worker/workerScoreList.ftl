...
<script src="static/scripts/account/workerScoreList.js?randomId=<%=Math.random()%>"></script>
</head>
<body>
  ...
  <div ng-controller="WorkerScoreListController">
     <input type="hidden" id="pageNo" value="${pageNo}" ng-init="pageNo='${pageNo}'">
      <input type="hidden" id="workerId" value="${Id}" ng-model="sf.workerId" ng-init="sf.workerId='${Id}'">
